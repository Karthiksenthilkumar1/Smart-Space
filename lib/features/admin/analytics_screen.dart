        ...
        child: isLoading
            ...
            : ListView(
                ...
                children: [
                  ...
                  ActivityTile(
                    icon: Icons.people,
                    text: "${analytics["users"]} users registered on platform",
                  ),
                  ActivityTile(
                    icon: Icons.camera_alt,
                    text: "${analytics["scans"]} total scans completed",
                  ),
                  ActivityTile(
                    icon: Icons.photo_camera,
                    text: "${analytics["imageScans"]} image scans completed",
                  ),
                  ActivityTile(
                    icon: Icons.videocam,
                    text: "${analytics["videoScans"]} video scans completed",
                  ),
                  ActivityTile(
                    icon: Icons.favorite,
                    text:
